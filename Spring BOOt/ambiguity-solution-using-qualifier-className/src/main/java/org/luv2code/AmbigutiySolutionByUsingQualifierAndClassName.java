...
public class AmbigutiySolutionByUsingQualifierAndClassName {

	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(AmbigutiySolutionByUsingQualifierAndClassName.class, args);
